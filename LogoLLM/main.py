...
from models.LogoLLM import LogoLLM
...
parser = argparse.ArgumentParser(description='LogoLLM')
...
parser.add_argument('--version', type=str, default='first_last')    ## The method to obtain local and global representations
